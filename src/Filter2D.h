...
//------------------------3x3 routines ------------------------------------
// THE MAIN ROUTINES HERE ARE THE convolution_optimized_3x3_many_loads and convolution_optimized_3x3_reg_blocking_16
void convolution_optimized_3x3_16_many_loads(unsigned char **frame1,unsigned char **filt,const unsigned int M, const unsigned int N, const unsigned short int divisor, signed char **filter);
